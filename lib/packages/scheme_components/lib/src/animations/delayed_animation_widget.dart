...
class DelayedDisplay extends StatefulWidget {
	...
	/// Will display Loading Indicator until delay passes.
	...
	const DelayedDisplay({
		...
		this.slidingBeginOffset = const Offset(0.0, 0.35), this.enableLoader = false,
	});
...
class _DelayedDisplayState extends State<DelayedDisplay>
	...
	bool get enableLoader => widget.enableLoader ?? false;
