...
String themeToCode(ThemeData theme,String font, String primaryFont,String accentFont) {
	return '''
  import 'package:flutter/material.dart';
  final ThemeData myTheme = ThemeData(
    ...
    textTheme: ${textThemeToCode(theme.textTheme,font)},
    primaryTextTheme: ${textThemeToCode(theme.primaryTextTheme,primaryFont)},
    accentTextTheme: ${textThemeToCode(theme.accentTextTheme,accentFont)},
    ...
    sliderTheme: ${sliderThemeToCode(
			theme.sliderTheme,
			theme.accentTextTheme.subtitle2,font
	)},
    tabBarTheme: ${tabBarThemeToCode(
		theme.tabBarTheme,
		defaultLabelColor: theme.primaryTextTheme.subtitle2.color,
	)},
    chipTheme: ${chipThemeToCode(
		theme.chipTheme,
		font,
		defaultLabelStyle: theme.textTheme.subtitle2,
	)},
...
Map<String, dynamic> themeToMap(ThemeData theme) {
	return <String, dynamic>{
		...
		/* FIXME'sliderTheme':
        sliderThemeToMap(theme.sliderTheme, theme.accentTextTheme.subtitle2),*/
...
String sliderThemeToCode(
		SliderThemeData sliderTheme, TextStyle defaultValueIndicatorStyle,String font) {
	return '''SliderThemeData(
      ...
      valueIndicatorTextStyle: ${textStyleToCode(defaultValueIndicatorStyle.merge(sliderTheme.valueIndicatorTextStyle),font)},
    )''';
}
...
String chipThemeToCode(ChipThemeData chipTheme,String font,
	...
	return '''ChipThemeData(
      ...
      labelStyle: ${textStyleToCode(
		defaultLabelStyle.merge(chipTheme.labelStyle),font,
	)},
