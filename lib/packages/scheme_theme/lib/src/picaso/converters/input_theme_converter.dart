...
String inputDecorationThemeToCode(InputDecorationTheme inputTheme,
    Color hintColor, TextStyle bodyStyle, Brightness brightness,String font) {
  ...
  InputDecorationTheme(
    labelStyle: ${textStyleToCode(inputTheme.labelStyle ?? defaultHintStyle,font)},
    helperStyle: ${textStyleToCode(inputTheme.helperStyle ?? defaultHintStyle,font)},
    hintStyle: ${textStyleToCode(inputTheme.hintStyle ?? defaultHintStyle,font)},
    errorStyle: ${textStyleToCode(inputTheme.errorStyle ?? defaultHintStyle,font)},
    ...
    prefixStyle: ${textStyleToCode(inputTheme.prefixStyle ?? defaultHintStyle,font)},
    suffixStyle: ${textStyleToCode(inputTheme.suffixStyle ?? defaultHintStyle,font)},
    counterStyle: ${textStyleToCode(
    inputTheme.counterStyle ?? defaultHintStyle,font)},
